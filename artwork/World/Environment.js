...
export default class Environment {
  ...
  async setStudioModel() {
    this.studioModel = await this.resources.items.studioLights.children.filter(
      (obj) => obj.name === "spot_light"
    )[0];
  ...
  setLensflare() {
    ...
    lensflare.addElement(
      new LensflareElement(
        this.resources.items.lensflare0,
        700,
        0,
    ...
    lensflare.addElement(
      new LensflareElement(this.resources.items.lensflare1, 60, 0.6)
    );
    lensflare.addElement(
      new LensflareElement(this.resources.items.lensflare1, 70, 0.7)
    );
    lensflare.addElement(
      new LensflareElement(this.resources.items.lensflare1, 120, 0.9)
    );
    lensflare.addElement(
      new LensflareElement(this.resources.items.lensflare1, 70, 1)
    );
